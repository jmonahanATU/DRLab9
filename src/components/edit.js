...
export default function Edit(props) {
    ...
    useEffect(() => {
        ...
        // make an HTTP Request with GET method and pass as part of the URL.
    ...
    const handleSubmit = (event) => {
        ...
        axios.put('http://localhost:4000/api/book/' + id, newBook)
            .then((res) => {
                ...
                // Navigate to the '/read' page after successful book edit
                navigate('/read');
            });
    }

    // Render the form for editing book details
    return (
        <div>
